...
@interface TestPullLoadingViewController ()
...
-(void) viewDidAppear:(BOOL)animated
{
    ...
    LC_UIActionSheet * actionSheet = [[LC_UIActionSheet alloc] initWithTitle:@"选择一个方式" delegate:nil cancelButtonTitle:@"取消" destructiveButtonTitle:nil otherButtonTitles:@"只有下拉刷新",@"只有上拉刷新",@"上拉下拉同时存在",nil];
    ...
    actionSheet.actionBlock = ^(LC_UIActionSheet * sheet, int clickIndex){
        ...
        [nRetainSelf actionSheet:sheet clickedButtonAtIndex:clickIndex];
    };
}
...
-(void) actionSheet:(LC_UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex
{
    LC_BLOCK_SELF;
