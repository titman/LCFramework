...
@implementation SVInfiniteScrollingDotView
...
- (void)addInfiniteScrollingWithActionHandler:(void (^)(void))actionHandler {
    ...
    if(!self.infiniteScrollingView) {
        ...
        SVInfiniteScrollingView *view = [[[SVInfiniteScrollingView alloc] initWithFrame:CGRectMake(0, self.contentSize.height, self.bounds.size.width, SVInfiniteScrollingViewHeight)] autorelease];
...
-(void) dealloc
{
    self.infiniteScrollingHandler = nil;
