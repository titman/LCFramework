...
/** GCD asynchronous (异步) */
#define LC_GCD_ASYNCHRONOUS(priority,aBlock) [LC_GCD dispatchAsync:priority block:aBlock]
/** GCD synchronous (同步) */
#define LC_GCD_SYNCHRONOUS(block) [LC_GCD dispatchAsyncInMainQueue:block]
