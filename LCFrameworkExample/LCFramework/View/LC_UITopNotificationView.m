...
+ (LC_UITopNotificationView *)showInView:(UIView *)view style:(LCTopNotificationViewType)style message:(NSString *)message
{
    ...
    return LC_AUTORELEASE(notificationView);
}
...
-(void) layout
{
    if (self.imageView.image) {
        ...
        float distanceSide = (LCUITopNotificationViewHeight - 16);
        self.label.frame = CGRectMake(8, 8, self.parentView.viewFrameWidth - 16, distanceSide);
    }
}
