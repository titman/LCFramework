...
//  Created by Licheng Guo . ( SUGGESTIONS & BUG titm@tom.com ) on 13-10-10.
...
-(void)setZeroLineStrokeColor:(UIColor*)color {
    ...
    if (zeroLineStrokeColor) {
        [zeroLineStrokeColor release];
    }
    
    zeroLineStrokeColor = [color retain];;
...
- (void)drawRect:(CGRect)rect {
    ...
    NSMutableArray * points = [[self arrayOfPoints] retain];
