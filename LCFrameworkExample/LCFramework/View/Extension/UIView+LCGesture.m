...
{
    __LC_PanGesture * panGesture = [[[__LC_PanGesture alloc] initWithTarget:target action:selector] autorelease];
...
{
    __LC_PinchGesture * pinchGesture = [[[__LC_PinchGesture alloc] initWithTarget:target action:selector] autorelease];
